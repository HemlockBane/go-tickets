...
String formatTime(String timeInMillisecs) {
  ...
  if (timeDifference.inHours >= 24 && timeDifference.inHours < 47) {
    print(
        'time_tool.dart - time difference in hours: ${timeDifference.inHours}');
    formattedTime = 'Yesterday';
  } else if (timeDifference.inHours > 47) {
    print(
        'time_tool.dart - time difference in hours: ${timeDifference.inHours}');
    formattedTime = formatDate(dateTime: dateTime);
    //formattedTime = 'Before yesterday';
  } else if (timeDifference.inHours <= 23) {
    print(
        'time_tool.dart - time difference in min: ${timeDifference.inMinutes}');
